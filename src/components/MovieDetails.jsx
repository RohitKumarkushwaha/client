      ...
      try {
        ...
        if (data.success) {
          setMovie({
            ...
            initialcompanyName: data.companyName || "",
            initialcarType: data.carType || "",
            initialcarName: data.carName || "",
      ...
      <Box p={2} style={{ marginLeft: "5%" }}>
        ...
        <Box mt={2}>
          <Typography variant="h6" gutterBottom>
            ...
            <span style={{ color: "#666" }}> {movie.initialcompanyName}</span>
          </Typography>
          <Typography variant="h6" gutterBottom>
            <span>Car Name:</span>{" "}
            <span style={{ color: "#666" }}> {movie.initialcarType}</span>
          </Typography>
          <Typography variant="h6" gutterBottom>
            <span>Car Type:</span>{" "}
            <span style={{ color: "#666" }}> {movie.initialcarName}</span>
          </Typography>
