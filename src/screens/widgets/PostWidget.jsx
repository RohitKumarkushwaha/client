...
const PostWidget = ({
  ...
  const [newcompanyName, setcompanyName] = useState(initialcompanyName);
  const [newcarType, setcarType] = useState(initialcarType);
  const [newcarName, setcarName] = useState(initialcarName);
    ...
    <WidgetWrapper m="2rem 0">
      ...
      >
        <img
          ...
          src={initialImgUrl}
          alt={initialcompanyName}
        />
        <Box className="card-body" style={{ padding: "20px" }}>
          <FlexBetween style={{ marginBottom: "10px" }}>
            <Typography variant="h6" gutterBottom>
              <span>Company Name:</span>{" "}
              <span style={{ color: "#666" }}> {initialcompanyName}</span>
            </Typography>
            <Typography variant="h6" gutterBottom>
              <span>Car Name:</span>{" "}
              <span style={{ color: "#666" }}> {initialcarName}</span>
            </Typography>
          </FlexBetween>
          <Typography variant="h6" gutterBottom>
            <span>Car Type:</span>{" "}
            <span style={{ color: "#666" }}> {initialcarType}</span>
          </Typography>
      ...
      <Dialog open={isReview} onClose={() => setIsReview(false)}>
        ...
        <DialogContent>
          <DialogContentText>
            Please enter your rating and review for this car.
          </DialogContentText>
          <Box mt="1rem">
            <StarRating
              value={rating}
      ...
      >
        ...
        >
          ...
          {(image ||
            ...
            newcompanyName !== initialcompanyName ||
            newcarType !== initialcarType ||
            newcarName !== initialcarName) && (
