...
const CreatePost = ({ picturePath }) => {
  ...
  const [companyName, setcompanyName] = useState(""); // New state for movie title
  const [carName, setcarName] = useState(""); // New state for carName
  const [carType, setcarType] = useState(""); // New state for release year
